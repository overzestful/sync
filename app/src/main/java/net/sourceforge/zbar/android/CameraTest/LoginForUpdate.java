...
public class LoginForUpdate extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        btnLogin.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(LoginForUpdate.this, "Login OK", Toast.LENGTH_SHORT).show();
                    Intent newActivity = new Intent(LoginForUpdate.this,UpdateActivity.class);
